...
def create_blood_type(blood_letter, rh):
...
def check_and_upload_data(patient_name, id_number, blood_letter, rh,
                          donation_center):
    blood_string = create_blood_type(blood_letter, rh)
...
def set_up_window():
    ...
    def shuffle_choices():
        # shuffles order of choices from dropdown
    ...
    check_box_widget = tk.Checkbutton(root, text="Rh Positive",
                                      ...
                                      onvalue="+", offvalue="-")
    check_box_widget.grid(column=1, row=4, sticky=tk.E)
    ...
    donation_combobox.grid(column=2, row=1, padx=5)
