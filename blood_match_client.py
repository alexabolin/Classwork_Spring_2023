...
recipient_blood_type = requests.get("{}/get_blood_type/{}"
                                    .format(server, recipient_id))
donor_id = patient_ids.get('Donor')
donor_blood_type = requests.get("{}/get_blood_type/{}"
                                .format(server, donor_id))
print(recipient_blood_type.text)
print(donor_blood_type.text)

result = 0
if (recipient_blood_type.text == donor_blood_type.text):
    result = "Yes"
else:
    result = "No"
